...
async function route(){const m=location.hash.match(/^#research=(.*)$/);if(!m)return;for(let n=0;n<100&&!window.workbenchReady;n++)await new Promise(r=>setTimeout(r,100));openView('research',decodeURIComponent(m[1]));}
